...
<\body>
  ...
  <math|n> is the number of nodes in the neural network

  <math|L> denotes the final layer in the neural network and
  <math|L-\<ldots\>> denotes previous layers

  <math|<with|font-series|bold|z><rsup|L>> is the calculated output
  <math|<with|font-series|bold|z><rsup|L>=<with|font-series|bold|a><rsup|L-1>*W<rsup|L>+B<rsup|L>>\ 

  <math|<with|font-series|bold|a><rsup|L>> is the activation function applied
  to <math|<with|font-series|bold|z><rsup|L>>. Note
  <math|<with|font-series|bold|a><rsup|L-H> > where <math|H> is the number of
  layers, is the input layer of the neural network.

  <math|W<rsup|L>> is the weights matrix

  <math|<with|font-series|bold|b><rsup|L> is the biases vector>

  <with|font-series|bold|<math|t>> is the target output given as a training
  example

  c is the loss/cost function

  Note bolded letters are vectors and capitalised letters are matrices
  ...
  Squared error is best for regression problems. That is, if I trying to
  predict a continuous scalar value.
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|>|<cell|c==<dfrac|1|2>*<big|sum><rsup|n><rsub|j=0><around*|(|<math-it|<with|font-series||t>><rsub|j>-<with|font-series||a><rsub|j><rsup|L>|)><rsup|2>=<dfrac|1|2><around*|(|<around*|(|<math-it|<with|font-series|bold|t>><rsub|0>-<with|font-series|bold|a><rsub|0><rsup|L>|)><rsup|2>+<around*|(|<math-it|<with|font-series|bold|t>><rsub|1>-<with|font-series|bold|a><rsub|1><rsup|L>|)><rsup|2>+\<cdots\>+<around*|(|<math-it|<with|font-series|bold|t>><rsub|n>-<with|font-series|bold|a><rsub|n><rsup|L>|)><rsup|2>|)>*>|<cell|>>|<row|<cell|>|<cell|<dfrac|\<mathd\><math-it|<with|font-series||c>><with|font-series|bold|>|\<mathd\><with|font-series||a><rsub|j><rsup|L>>=a<rsup|L><rsub|j>-t>|<cell|>>>>
  </eqnarray*>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|>|<cell|<with|font-series||<math-it|<with|font-series||c>>>=<dfrac|1|2>***<around*|(|<math-it|<with|font-series|bold|t>><rsub|>-<with|font-series|bold|a><rsub|><rsup|L>|)><rsup|2>>|<cell|>>|<row|<cell|>|<cell|<dfrac|\<mathd\><math-it|<with|font-series||c>><with|font-series|bold|>|\<mathd\><with|font-series|bold|a><rsup|L>>=*<math-it|<with|font-series|bold|>><with|font-series|bold|a><rsup|L>-t=<matrix|<tformat|<table|<row|<cell|<with|font-series||a><rsub|0><rsup|L>-<math-it|<with|font-series||t>><rsub|0>>>|<row|<cell|<with|font-series||a><rsub|1><rsup|L>-<math-it|<with|font-series||t>><rsub|1>>>|<row|<cell|\<vdots\>>>|<row|<cell|<with|font-series||a><rsub|n><rsup|L>-<math-it|<with|font-series||t>><rsub|n>>>>>>>|<cell|>>>>
  </eqnarray*>

  <subsection|Cross entropy>

  Cross entropy is best for classification problems.
  ...
  This is necessary to allow the neural network to learn a more complicated
  problem space. Without such, it would be like trying to model a parabola
  with a straight line.

  Note that the backpropigation is meaningfully different if the activation
  function is a vector or scalar function.The sigmoid function is a scalar
  function (outputs a single value), whereas the softmax function is a vector
  function (outputs a vector).
...
<\references>
  <\collection>
    ...
    <associate|auto-11|<tuple|5.1.1|6>>
    <associate|auto-12|<tuple|5.1.2|7>>
    <associate|auto-13|<tuple|5.2|8>>
    <associate|auto-14|<tuple|5.2.1|8>>
    <associate|auto-15|<tuple|5.2.2|9>>
    <associate|auto-16|<tuple|A|10>>
    <associate|auto-17|<tuple|B|12>>
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      ...
      <with|par-left|<quote|2tab>|5.1.1<space|2spc>Element form
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-11>>

      <with|par-left|<quote|2tab>|5.1.2<space|2spc>Matrix form
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      ...
      <with|par-left|<quote|2tab>|5.2.1<space|2spc>Element form
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-14>>

      <with|par-left|<quote|2tab>|5.2.2<space|2spc>Matrix form
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
